...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand" href="index.php">HYDERABAD'S NEXT GALLERIA Vehicle Parking Management System</a>
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <!-- Masthead Heading-->
                <h1 class="masthead-heading text-uppercase mb-0">HYDERABAD'S NEXT GALLERIA Vehicle Parking Management System</h1>
                <!-- Icon Divider-->
        ...
        <div class="copyright py-4 text-center text-white">
            <div class="container"><small>HYDERABAD'S NEXT GALLERIA_2022@DEPT_OF_IT</small></div>
        </div>
        <!-- Bootstrap core JS-->
